...
The current release build completes with zero warnings. The test suite has 176 passing tests.
...
- Generic HTTPS webhook, authenticated TLS SMTP email, and Telegram Bot delivery are configurable; the remaining provider adapters are roadmap work.
