...
The current release build completes with zero warnings. The test suite has 199 passing tests.
...
- Generic HTTPS webhook, authenticated TLS SMTP email, Telegram Bot, and Discord webhook delivery are configurable; the remaining provider adapters are roadmap work.
