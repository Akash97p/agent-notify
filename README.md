...
The current release build completes with zero warnings. The test suite has 289 passing tests.
...
- Generic HTTPS webhook, authenticated TLS SMTP email, Telegram Bot, Discord, Slack, Teams Workflows, Zoho Cliq, and Google Chat delivery are configurable; the remaining provider adapters are roadmap work.
