...
[![Version](https://img.shields.io/badge/version-0.2.0--alpha.1-2563eb.svg)](Directory.Build.props)
...
> **Development status:** Pre-release `v0.2.0-alpha.1` — AgentNotify is under active development and has not reached the mature `v1.0.0` release. Builds are for testing and evaluation; expect incomplete features, breaking changes, and unsigned binaries.
