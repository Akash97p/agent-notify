...
export const docs: DocDefinition[] = [
  ...
  { source: "docs/CHANNELS.md", slug: "channels", title: "Outbound channels", section: "Using AgentNotify", description: "Eighteen opt-in adapters and their security policies." },
