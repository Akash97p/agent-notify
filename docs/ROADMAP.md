...
3. Telegram Bot API plus Discord and Slack incoming webhooks (implemented), followed by Microsoft Teams Workflows, Zoho Cliq, Google Chat, Mattermost, and Matrix.
