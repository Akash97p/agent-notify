...
3. Telegram Bot API, Discord/Slack webhooks, and global-cloud Microsoft Teams Workflows (implemented), followed by Zoho Cliq, Google Chat, Mattermost, and Matrix.
