...
20. Next: Gotify REST message adapter with encrypted application token and self-hosted server policy.
21. Additional channels in the priority order maintained in `docs/FEATURE_BACKLOG.md`.
