...
14. Next: Microsoft Teams Workflows webhook adapter and provider-specific Settings fields.
15. Additional channels in the priority order maintained in `docs/FEATURE_BACKLOG.md`.
