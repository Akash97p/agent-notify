...
17. Next: Mattermost incoming webhook adapter with explicit self-hosted destination and TLS policy.
18. Additional channels in the priority order maintained in `docs/FEATURE_BACKLOG.md`.
