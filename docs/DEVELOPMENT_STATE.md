...
19. Next: ntfy HTTP publish adapter for hosted/self-hosted servers with topic privacy and authentication controls.
20. Additional channels in the priority order maintained in `docs/FEATURE_BACKLOG.md`.
