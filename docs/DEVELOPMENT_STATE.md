...
18. Next: Matrix Client-Server API adapter with encrypted access token, homeserver policy, and explicit room targeting.
19. Additional channels in the priority order maintained in `docs/FEATURE_BACKLOG.md`.
