...
- [x] Automated tests: 693 passed, 0 failed, 0 skipped
...
- [x] AgentNotify Relay adapter with self-hosted/Custom HTTPS envelope API, encrypted installation token, DNS pinning, and durable outbox (Relay Go hosted UI disabled; experimental opaque transport; real-relay pairing and E2E review pending)
- [ ] Email provider API adapters
