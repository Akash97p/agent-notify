...
cp "$ROOT/src/AgentNotify.Protocol/Schemas/arc-0.2.schema.json" "$PUBLIC/schemas/"
...
test -s "$OUT/docs/router/index.html"
test -s "$OUT/docs/security/index.html"
test -s "$OUT/docs/install-with-agent/index.html"
...
test -s "$OUT/schemas/arc-0.2.schema.json"
cmp -s "$ROOT/src/AgentNotify.Protocol/Schemas/arc-0.1.schema.json" "$OUT/schemas/arc-0.1.schema.json"
cmp -s "$ROOT/src/AgentNotify.Protocol/Schemas/arc-0.2.schema.json" "$OUT/schemas/arc-0.2.schema.json"
